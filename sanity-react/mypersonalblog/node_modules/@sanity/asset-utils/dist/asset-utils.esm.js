...
var fileAssetFilenamePattern = /^[a-f0-9]+\.[a-z0-9]+$/;
/**
 * @internal
 */

var fileAssetIdPattern = /^file-[a-f0-9]+-[a-z0-9]+$/;
/**
 * @internal
 */

var imageAssetFilenamePattern = /^[a-f0-9]+-\d+x\d+\.[a-z0-9]+$/;
/**
 * @internal
 */

var imageAssetIdPattern = /^image-[a-f0-9]+-\d+x\d+-[a-z0-9]+$/;
/**
 * @internal
 */
...
var idPattern = /^(?:image-[a-f0-9]+-\d+x\d+-[a-z0-9]+|file-[a-f0-9]+-[a-z0-9]+)$/;
/**
...
function parseAssetFilename(filename) {
  ...
  try {
    ...
    var assetId = file.replace(/\.([a-z+]+)$/i, '-$1');
...
export { DEFAULT_CROP, DEFAULT_HOTSPOT, buildFilePath, buildFileUrl, buildImagePath, buildImageUrl, getAssetDocumentId, getDefaultCrop, getDefaultHotspot, getExtension, getFile, getFileAsset, getIdFromString, getImage, getImageAsset, getImageDimensions, getProject, getUrlFilename, getUrlPath, isAssetFilename, isAssetIdStub, isAssetObjectStub, isAssetPathStub, isAssetUrlStub, isDefaultCrop, isDefaultHotspot, isFileAssetFilename, isFileSource, isImageAssetFilename, isImageSource, isObject, isReference, isSanityFileAsset, isValidFilename, parseAssetFilename, parseAssetId, parseFileAssetId, parseImageAssetId, tryGetAssetDocumentId, tryGetAssetPath, tryGetExtension, tryGetFile, tryGetFileAsset, tryGetIdFromString, tryGetImage, tryGetImageAsset, tryGetImageDimensions, tryGetProject, tryGetUrlFilename, tryGetUrlPath };
