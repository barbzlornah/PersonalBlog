...
var useReporterGuard = id => {
  throw new Error("No context provided for reporter. Make sure that the component calling \"useReporter(".concat(id, ", ...)\", is wrapped in a <Tracker> element"));
};

var useReportedValueGuard = () => {
  throw new Error('No context provided for reporter. Make sure that the component calling "useReportedValues()", is wrapped inside a <Tracker> element');
};
