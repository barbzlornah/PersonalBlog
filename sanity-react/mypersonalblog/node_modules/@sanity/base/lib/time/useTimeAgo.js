...
function formatRelativeTime(date) {
  ...
  if (diffWeeks) {
    if (opts.minimal) {
      return {
        timestamp: "".concat(diffWeeks, "w"),
        refreshInterval: ONE_HOUR
      };
    }

    return {
      timestamp: "".concat(diffWeeks, " weeks ago"),
      refreshInterval: ONE_HOUR
    };
  }
  ...
  if (diffDays) {
    if (opts.minimal) {
      return {
        timestamp: diffDays === 1 ? 'yesterday' : "".concat(diffDays, "d"),
        refreshInterval: ONE_HOUR
      };
    }

    return {
      timestamp: diffDays === 1 ? 'yesterday' : "".concat(diffDays, " days ago"),
      refreshInterval: ONE_HOUR
    };
  }
  ...
  if (diffHours) {
    if (opts.minimal) {
      return {
        timestamp: "".concat(diffHours, "h"),
        refreshInterval: ONE_MINUTE
      };
    }

    return {
      timestamp: "".concat(diffHours, " hours ago"),
      refreshInterval: ONE_MINUTE
    };
  }
  ...
  if (diffMins) {
    if (opts.minimal) {
      return {
        timestamp: "".concat(diffMins, "m"),
        refreshInterval: TWENTY_SECONDS
      };
    }

    return {
      timestamp: "".concat(diffMins, " minutes ago"),
      refreshInterval: TWENTY_SECONDS
    };
  }
  ...
  if (diffSeconds > 10) {
    if (opts.minimal) {
      return {
        timestamp: "".concat(diffSeconds, "s"),
        refreshInterval: FIVE_SECONDS
      };
    }

    return {
      timestamp: "".concat(diffSeconds, " seconds ago"),
      refreshInterval: FIVE_SECONDS
    };
  }
