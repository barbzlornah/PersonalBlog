...
class DropDownButton extends _react.default.PureComponent {
  ...
  constructor(props) {
    ...
    _defineProperty(this, "_buttonElement", /*#__PURE__*/_react.default.createRef());

    _defineProperty(this, "_firstItemElement", /*#__PURE__*/_react.default.createRef());

    _defineProperty(this, "_menuElement", null);

    _defineProperty(this, "menuHasKeyboardFocus", false);

    _defineProperty(this, "keyboardNavigation", false);

    _defineProperty(this, "menuId", null);
  ...
  render() {
    var _omit2 = (0, _omit3.default)(this.props, 'onAction'),
        ...
        _omit2$placement = _omit2.placement,
        placement = _omit2$placement === void 0 ? 'bottom-start' : _omit2$placement,
        _omit2$showArrow = _omit2.showArrow,
        showArrow = _omit2$showArrow === void 0 ? true : _omit2$showArrow,
    ...
    var _buttonElement = this._buttonElement && this._buttonElement.current && this._buttonElement.current._element;

    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_default.default, _extends({}, rest, {
      "data-menu-button-id": this.menuId,
      className: (0, _classnames.default)(_dropdownStyle.default.button, className),
      onClick: this.handleOnClick,
      kind: kind,
      onKeyDown: this.handleButtonKeyDown,
      onBlur: this.handleButtonBlur,
      ref: this._buttonElement
    }), (showArrow || children) && /*#__PURE__*/_react.default.createElement("div", {
    ...
    }, /*#__PURE__*/_react.default.createElement(_angleDownIcon.default, null))) : children)), menuOpened && /*#__PURE__*/_react.default.createElement(_poppable.default, {
      modifiers: modifiers,
      placement: placement,
    ...
    }, /*#__PURE__*/_react.default.createElement(_build.default, null, items.map((item, i) => /*#__PURE__*/_react.default.createElement(_default2.Item, {
      key: String(i),
    ...
    }, renderItem ? renderItem(item) : /*#__PURE__*/_react.default.createElement("div", null, item.title))))), /*#__PURE__*/_react.default.createElement("div", {
      tabIndex: 0,
