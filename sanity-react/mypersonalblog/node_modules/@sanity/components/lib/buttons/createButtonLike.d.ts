...
export default function createButtonLike(as: ButtonComponent | 'button' | 'a', { displayName, defaultProps }: ButtonComponentOpts): {
    new (props: Readonly<ButtonProps>): {
        ...
        render(): JSX.Element;
        context: any;
        setState<K extends "focusSetFromOutside">(state: ButtonState | ((prevState: Readonly<ButtonState>, props: Readonly<ButtonProps>) => ButtonState | Pick<ButtonState, K> | null) | Pick<ButtonState, K> | null, callback?: (() => void) | undefined): void;
