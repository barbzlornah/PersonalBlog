...
var noop = () => undefined; // @todo: refactor to functional component
...
class FullScreenDialog extends _react.default.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_StackedEscapable.default, {
    ...
    }, /*#__PURE__*/_react.default.createElement(_portal.Portal, null, /*#__PURE__*/_react.default.createElement("section", {
      ...
      className: (0, _classnames.default)(_fullscreenStyle.default.inner, cardClassName)
      ...
      onClick: onClose,
      padding: "small"
    }))), this.props.children && /*#__PURE__*/_react.default.createElement(_scroll.ScrollContainer, {
