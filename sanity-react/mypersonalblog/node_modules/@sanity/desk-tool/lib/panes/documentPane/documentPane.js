...
var _ReportChangesPanel = require("@sanity/base/lib/change-indicators/overlay/ReportChangesPanel");
...
function DocumentPane(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_keyboardShortcuts.DocumentActionShortcuts, {
    ...
    views: views
  })), features.reviewChanges && !isCollapsed && isChangesOpen && /*#__PURE__*/_react.default.createElement(_ReportChangesPanel.ReportChangesPanel, {
