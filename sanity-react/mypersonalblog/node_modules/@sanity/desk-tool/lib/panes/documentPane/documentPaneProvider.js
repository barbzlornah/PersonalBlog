...
var DocumentPaneProvider = (0, _withInitialValue.default)(function DocumentPaneProvider(props) {
  ...
  var _useDocumentOperation = (0, _reactHooks.useDocumentOperation)(documentIdRaw, documentTypeName),
      patch = _useDocumentOperation.patch;

  var editState = (0, _reactHooks.useEditState)(documentIdRaw, documentTypeName);

  var _useValidationStatus = (0, _reactHooks.useValidationStatus)(documentIdRaw, documentTypeName),
      markers = _useValidationStatus.markers;

  var connectionState = (0, _reactHooks.useConnectionState)(documentIdRaw, documentTypeName);
