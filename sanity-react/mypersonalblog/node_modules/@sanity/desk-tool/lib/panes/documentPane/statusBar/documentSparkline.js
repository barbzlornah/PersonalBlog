...
function DocumentSparkline(_ref2) {
  ...
  var lastUpdatedTimeAgo = (0, _hooks.useTimeAgo)(lastUpdated || ''); // Make sure we only show editDraft sessions (and count the unpublish as a draft session)
  ...
  return /*#__PURE__*/_react.default.createElement(_containerQuery.ContainerQuery, {
    ...
    var icon = (syncState === null || syncState === void 0 ? void 0 : syncState.isSyncing) ? _syncIcon.default : undefined;
